...
public class DtCurso  implements java.io.Serializable {
    ...
    public DtCurso(int cantHoras, java.lang.String[] categorias, int creditos, java.lang.String desc, int duracion, java.util.Date fechaR,
           java.lang.String nombre, java.lang.String[] previas, java.lang.String url) {
     ...
     * @return fechaR
     */
    public java.util.Date getFechaR() {
        return fechaR;
    }
     ...
     * @param fechaR
     */
    public void setFechaR(java.util.Date fechaR) {
        this.fechaR = fechaR;
    }
